...
read a
if [ `expr $a % 3` -eq 0 -a `expr $a % 5` -eq 0  -a `expr $a % 7` -eq 0 ] 
then echo -e "$a is divisible by 3, 5 and 7"; 
elif [ `expr $a % 3` -eq 0 -a `expr $a % 5` -eq 0 ] 
then echo -e "$a is divisible by 3 and 5"; 
elif [ `expr $a % 3` -eq 0 -a `expr $a % 7` -eq 0 ] 
then echo -e "$a is divisible by 3 and 7"; 
elif [ `expr $a % 5` -eq 0 -a `expr $a % 7` -eq 0 ] 
